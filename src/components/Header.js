...
function Header() {
    return (
        <nav className='flex items-center justify-center flex-wrap py-6 bg-[#383838] px-6 '>
            ...
            <div className='w-full block flex-grow lg:flex lg:item-center lg:w-auto'>
                <div className='text-sm lg:flex-grow border-'>
                ...
                <div className='relative'>
                    <span className='bg-red-600 px-3 py-1 rounded-full text-white text-sm mb-3 absolute bottom-2'>6</span>
